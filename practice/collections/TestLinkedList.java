...
public class TestLinkedList {
    ...
    private static void testSubList() {
        ...
        LinkedList<Integer> testSubList1 = 
            (LinkedList<Integer>) testArr.subList(1, 2);
        LinkedList<Integer> testSubList2 = 
            (LinkedList<Integer>) testArr.subList(2, 4);
        LinkedList<Integer> testSubList3 = 
            (LinkedList<Integer>) testArr.subList(0, 4);
